...
Zin=conj(ZL); %Impedancia donde tenemos que llegar. 
    ...
    for l1=0:0.0001:0.5
        for l2=0:0.0001:0.5
            ...
            Zx=-1j*Zostub*cot(2*pi*l1); %Impedancia del stub (el stub está en abierto)
            Zy=(Zx*50)/(Zx+50);
            Zz=(Zolinea*(Zy+1j*Zolinea*tan(2*pi*l2)))/(Zolinea+1j*Zy*tan(2*pi*l2)); % Impedancia al inicio de la linea
